...
LDFLAGS =
SOURCES = main.cpp text_decode_sso.cpp text_encode_sso.cpp arg_parser.cpp text_decode_naive_implementation.cpp text_encode_naive_implementation.cpp text_decode_base85.cpp text_encode_base85.cpp
OBJ = $(SOURCES:.cpp=.o)
EXECUTABLE = run
dir = build
